...
const RegisterPage = () => {
  ...
  return (
    <div style={{
      ...
      <div className="flex flex-col md:flex-row w-full max-w-[900px] bg-white rounded-[20px] overflow-hidden shadow-[0_8px_60px_rgba(0,0,0,0.12)] border border-[#e8e8e8] min-h-[620px]">

        {/* Left Side - Form */}
        <div className="flex-1 md:flex-none md:w-1/2 p-8 md:p-[48px_44px] flex flex-col justify-center bg-[#fafafa]">
        ...
        {/* Right Side - Branding */}
        <div className="hidden md:flex flex-1 bg-[#1a1a1a] relative overflow-hidden items-center justify-center">
