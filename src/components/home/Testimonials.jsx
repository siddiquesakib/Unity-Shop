          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {getVisible().map((t, i) => (
                <div
                  key={t._id || i}
                  className="relative bg-white/40 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/60 hover:border-white/40 hover:shadow-lg transition-all duration-300"
                >
                  {/* Quote mark */}
