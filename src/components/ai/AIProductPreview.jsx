  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2.5 bg-black text-white rounded-xl font-semibold shadow-lg hover:bg-gray-800 transform hover:scale-105 transition-all duration-200"
      >
        <FiZap size={18} />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                    <FiUpload size={20} className="text-black" />
                  ...
                  {!originalImage ? (
                    <div
                      ...
                      className="border-2 border-dashed border-gray-300 rounded-2xl p-12 text-center cursor-pointer hover:border-black hover:bg-gray-50 transition-all"
                    >
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-black text-white rounded-lg text-sm font-medium">
                        <FiUpload size={16} />
                        Choose File
                      </div>
                      <input
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute bottom-3 left-3 px-3 py-1.5 bg-black/70 text-white text-xs font-medium rounded-full">
                        Original Image
                      </div>
                    </div>
                  )}
                ...
                <div>
                  <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                    <FiZap size={20} className="text-black" />
                    AI Enhanced Preview
                  </h3>
                    ...
                    <div className="space-y-4">
                      <div className="border-2 border-dashed border-gray-300 rounded-2xl p-12 text-center bg-gray-50">
                        <div className="w-16 h-16 bg-gray-200 rounded-2xl mx-auto mb-4 flex items-center justify-center">
                          <FiZap size={32} className="text-gray-600" />
                        </div>
                        <p className="text-gray-900 font-semibold mb-1">
                          Ready to enhance!
                        </p>
                        ...
                        <button
                          ...
                          disabled={loading}
                          className="inline-flex items-center gap-2 px-6 py-3 bg-black text-white rounded-xl font-semibold shadow-lg hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                        >
                          {loading ? (
                            <>
                  ...
                  {enhancedImage && (
                    <div className="space-y-4">
                      <div className="relative aspect-square rounded-2xl overflow-hidden bg-gray-100 border-2 border-black shadow-lg">
                        <Image
                          src={enhancedImage}
                          alt="Enhanced"
                          fill
                          className="object-contain"
                        />
                        <div className="absolute top-3 left-3 px-3 py-1.5 bg-black text-white text-xs font-bold rounded-full flex items-center gap-1.5">
                          <FiCheck size={14} />
                          Enhanced by AI
                        </div>
                      </div>
                      ...
                      {showComparison && (
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div className="relative aspect-square rounded-xl overflow-hidden border-2 border-black">
                            <Image
                              src={enhancedImage}
                              alt="Enhanced"
                              fill
                              className="object-contain"
                            />
                            <div className="absolute bottom-2 left-2 px-2 py-1 bg-black text-white text-xs rounded-full font-semibold">
                              After
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-black text-white rounded-xl font-semibold hover:bg-gray-800 transition-all"
                        >
                          <FiCheck size={18} />
                          Use This Image
                        </button>
